...
# Heat Check
heat = "🔥" if rsi > 65 else "❄️" if rsi < 35 else "⚖️"
...
"RSI": round(rsi, 1), "Decision": decision, "EMA21": round(ema21, 2), "Heat": heat
}
...
# כאן הוספתי את ה-Heat Emoji ליד השם
st.subheader(f"{res['Ticker']} {res['Heat']}")
